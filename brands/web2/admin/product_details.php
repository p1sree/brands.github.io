...
<div class="header">
 ...
 <p style="color:green; "> <?php //echo "Code   ".$_SESSION["USERID"];  ?> 	  
   ...
   <thead>
	<th>SN</th><th>Product Id</th><th >Product Name</th><th>Brands</th><th >Selling Price</th><th>Offer Price</th><th> Image</th><th> Delete</th>
		</thead>
   <?php
...
<tr><td><?php echo $pcode;?></td><td><b><?php echo $pname;?></b></td><td><?php echo $brands;?></td><td><b><?php echo $sp;?></b></td>
<td><b><?php echo $offer;?></b></td><td><b><?php echo $images;?></br>
<td>  <img src="imagess/<?php echo $images;?>" class="img-responsive" alt="" width="300px"/></td>
<td><a href="delete.php?sid=<?php echo $i;?>&a=1">REMOVE</a></td>
